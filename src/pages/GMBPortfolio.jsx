...
const list = [
  {
    name: "Restaurant GMB Optimization",
    desc: "Complete Google My Business optimization for a restaurant including profile setup, category optimization, keyword targeting, and improved visibility on Google Maps.",
    img: "https://images.unsplash.com/photo-1556740738-b6a63e27c4df?w=800",
    additionalLink1: "https://share.google/q3kSaxizlbPimtTAT",
  },
  {
    name: "Local Business SEO",
    desc: "Google Business Profile optimization project focused on improving local SEO ranking and increasing customer engagement through optimized posts and services.",
    img: "https://images.unsplash.com/photo-1521791136064-7986c2920216?w=800",
    additionalLink1: "https://share.google/9IJfmTbkBqFUE6GEs",
  },
  {
    name: "Clinic GMB Profile Setup",
    desc: "Medical clinic Google Business profile optimization including service listing, keyword improvement, and better search visibility on Google Maps.",
    img: "https://images.unsplash.com/photo-1581093588401-22fdbd9e4c5b?w=800",
    additionalLink1: "https://share.google/G7YI9IAIQJQl7ivTH",
  },
  {
    name: "Real Estate Local Listing",
    desc: "Google Maps business listing optimization for a real estate company to increase property inquiries and local search rankings.",
    img: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800",
    additionalLink1: "https://share.google/HxmcDsipjU1dj0xOk",
  },
  {
    name: "Salon GMB Marketing",
    desc: "Beauty salon Google Business Profile management including review growth strategy, photo optimization, and local search ranking improvements.",
    img: "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=800",
    additionalLink1: "https://share.google/Z9tEVoZcqKmcDMfaw",
  },
  {
    name: "Gym Local SEO",
    desc: "Fitness center Google Maps optimization project focused on improving local search visibility and attracting nearby customers.",
    img: "https://images.unsplash.com/photo-1571902943202-507ec2618e8f?w=800",
    additionalLink1: "https://share.google/ZZIDzaNFAY4dW3oZa",
  },
  {
    name: "Retail Store Google Maps Ranking",
    desc: "Retail store GMB profile optimization to increase walk-in customers and improve Google Maps ranking through proper SEO practices.",
    img: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=800",
    additionalLink1: "https://maps.app.goo.gl/Zri43UrYQgZ6dn947",
  },
  {
    name: "Local Service Business Listing",
    desc: "Google Business listing optimization for a service based company focusing on better engagement, reviews and local SEO ranking.",
    img: "https://images.unsplash.com/photo-1557804506-669a67965ba0?w=800",
    additionalLink1: "https://share.google/vudVYKU7Ku0NNwFmH",
  },
];
